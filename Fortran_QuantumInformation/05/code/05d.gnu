...
fit f1(x) "results/diag_50_samples_2500_N_glob.dat"          u 1:2 via a1, b1, c1, d1
fit f2(x) "results/diag_50_samples_2500_N_250_level_loc.dat" u 1:2 via a2, b2, c2, d2
fit f3(x) "results/diag_50_samples_2500_N_50_level_loc.dat"  u 1:2 via a3, b3, c3, d3
fit f4(x) "results/diag_50_samples_2500_N_10_level_loc.dat"  u 1:2 via a4, b4, c4, d4
...
#plot the graphic
plot "results/diag_50_samples_2500_N_glob.dat"          u 1:2 with p ls 1 lc rgb '#1f77b4'      pt 7 lw 0 ps 0.5 title "P(s) (global)", \
     f1(x)                                                    with l ls 1 lc rgb '#1f77b4' lt 1      lw 2        title sprintf("P(s)=%.2f s^{%.2f} e^{-%.2f s^{%.2f}}", a1, b1, c1, d1), \
     "results/diag_50_samples_2500_N_250_level_loc.dat" u 1:2 with p ls 1 lc rgb '#ff7f0e'      pt 7 lw 0 ps 0.5 title "P(s) (local, level=250)", \
     f2(x)                                                    with l ls 1 lc rgb '#ff7f0e' lt 1      lw 2        title sprintf("P(s)=%.2f s^{%.2f} e^{-%.2f s^{%.2f}}", a2, b2, c2, d2), \
     "results/diag_50_samples_2500_N_50_level_loc.dat"  u 1:2 with p ls 1 lc rgb '#2ca02c'      pt 7 lw 0 ps 0.5 title "P(s) (local, level=50)", \
     f3(x)                                                    with l ls 1 lc rgb '#2ca02c' lt 1      lw 2        title sprintf("P(s)=%.2f s^{%.2f} e^{-%.2f s^{%.2f}}", a3, b3, c3, d3), \
     "results/diag_50_samples_2500_N_10_level_loc.dat"  u 1:2 with p ls 1 lc rgb '#d62728'      pt 7 lw 0 ps 0.5 title "P(s) (local, level=10)", \
